...
export function NavBar({ location }: { location: string }) {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-40 flex justify-between items-center px-6 md:px-10 py-5 border-b border-black/5 bg-white/80 backdrop-blur-sm">
